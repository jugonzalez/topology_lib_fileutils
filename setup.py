...
setup(
    name='topology_lib_fileutils',
    version=find_version('lib/topology_lib_fileutils/__init__.py'),
    package_dir={'': 'lib'},
    ...
    url='https://github.com/HPENetworking/topology_lib_fileutils/tree/master/doc',
    keywords='topology_lib_fileutils',
    ...
    entry_points={
        'topology_library_10': [
            'fileutils = topology_lib_fileutils.library'
        ]
    }
)
